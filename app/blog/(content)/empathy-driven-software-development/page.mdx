...
export const metadata = {
  ...
  openGraph: {
    ...
    description:
      "A discussion on the importance of empathy in software development and how it can improve your work.",
    url: "<https://www.promptfolio.dev/blog/empathy-driven-software-development>",
...
<h2 id="feedback-culture">Feedback Culture</h2>
...
<h2 id="customer-support-and-communication">
...
<h2 id="impact-on-product-quality">Impact on Product Quality</h2>
