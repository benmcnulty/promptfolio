...
import { ArticleWorkWithBen } from "@/components/ArticleWorkWithBen";
import { BeforeAfterComparison } from "@/components/BeforeAfterComparison";
import { blog } from "@/lib/blog";

export const postMetadata = blog.find(
  (post) => post.slug === "rebuilding-promptfolio-without-losing-its-spark"
);
...
export const metadata = {
  ...
  creator: "Ben McNulty",
  keywords: ["frontend engineering", "design systems", "accessibility", "regression testing", "Next.js"],
  openGraph: {
    title: postMetadata.title,
    description: postMetadata.description,
    ...
    images: [{
      ...
      width: 1440,
      height: 800,
      alt: "The redesigned Promptfolio homepage",
    }],
    locale: "en_US",
    type: "article",
  ...
  twitter: {
    ...
    title: postMetadata.title,
    description: postMetadata.description,
    images: [`https://www.promptfolio.dev${postMetadata.imageUrl}`],
  },
};
...
<BeforeAfterComparison
  before="/promptfolio-redesign-2026/before-home-focused-dark.webp"
  after="/promptfolio-redesign-2026/after-home-redesign.webp"
  alt="Promptfolio homepage at desktop width"
  beforeCaption="The original homepage concentrated its title, description, navigation, theme control, social links, and attribution inside one large decorative header."
  afterCaption="The final hero turns the introduction into an asymmetrical editorial composition with a translucent prismatic mark and dimensional entry points."
  height={800}
/>
...
<BeforeAfterComparison
  before="/promptfolio-redesign-2026/before-catalog-focused-dark.webp"
  after="/promptfolio-redesign-2026/after-catalog-redesign.webp"
  alt="Promptfolio catalog at desktop width"
  beforeCaption="The original catalog moved directly from category controls into a dense card grid, with limited hierarchy and no text search or result feedback."
  afterCaption="The new catalog joins search, filters, result feedback, and a responsive list/grid control; this desktop view keeps the artwork-led grid while narrow screens start with compact rows."
  height={800}
/>
...
<BeforeAfterComparison
  before="/promptfolio-redesign-2026/before-writing-focused-dark.webp"
  after="/promptfolio-redesign-2026/after-writing-redesign.webp"
  alt="Promptfolio writing archive at desktop width"
  beforeCaption="The original writing index gave every article the same visual weight in a repeated card list."
  afterCaption="The refreshed archive promotes the newest story, surfaces dates and categories, and uses an editorial grid that is easier to scan."
  height={800}
/>
...
<BeforeAfterComparison
  before="/promptfolio-redesign-2026/before-about-mobile-focused-dark.webp"
  after="/promptfolio-redesign-2026/after-about-mobile-redesign.webp"
  alt="Promptfolio About page at mobile width"
  beforeCaption="The original mobile About page relied on oversized promotional panels and repeated calls to action, leaving little room for project context."
  afterCaption="The redesigned page uses concise project sections, a responsive human-orbit motif, and compact next-step links that fit the narrow viewport."
  width={390}
  height={780}
/>
