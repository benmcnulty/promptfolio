...
export function Footer() {
  return (
    <footer className="bg-white dark:bg-gray-800 py-8 px-6">
      ...
      <p className="leading-7 text-center mt-4">{strings.footer.conclusion}</p>
      <p className="leading-7 text-center mt-4">{strings.footer.extra}</p>
      <p className="leading-7 text-center mt-4">{strings.footer.copyright}</p>
    </footer>
  );
}
//
